    ...
    <>
      ...
      <Transition show={isOpen}>
        ...
        >
          ...
          >
            <Dialog.Panel className="fixed bottom-0 right-0 top-0 flex h-full w-full flex-col bg-white p-6 md:w-[380px]">
              ...
              {!cart || cart.lines.length === 0 ? (
                <div className="flex flex-1 flex-col items-center justify-center">
                  ...
                  <Link
                    ...
                    onClick={closeCart}
                    className="mt-6 rounded-full bg-neutral-950 px-5 py-2.5 text-sm font-medium text-white"
                  >
                    Shop
                  </Link>
                </div>
                ...
                <div className="flex h-full flex-col overflow-hidden pt-4">
                  ...
                  <div className="border-t border-neutral-200 pt-4">
                    ...
                    <Link
                      href="/checkout"
                      onClick={closeCart}
                      className="block w-full rounded-full bg-neutral-950 py-3 text-center text-sm font-medium text-white transition hover:bg-neutral-800"
                    >
                      Checkout
                    </Link>
                  </div>
...
function CloseCart({ className }: { className?: string }) {
  return (
    <div className="flex h-9 w-9 items-center justify-center rounded-full text-neutral-400 transition hover:text-neutral-950">
